...
class UbicationDetailDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbarUbication.navigationIcon = ContextCompat.getDrawable(view.context, R.drawable.ic_close_black_24dp)
        ...
        tvDetailUbication.text = ubication.address
        tvDetailPhone.text = ubication.phone
        tvDetailWebsite.text = ubication.website
        ...
        tvDetailWebsite.setOnClickListener {
